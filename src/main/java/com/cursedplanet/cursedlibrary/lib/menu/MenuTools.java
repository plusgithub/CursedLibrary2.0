...
import com.cursedplanet.cursedlibrary.lib.menu.tool.Tool;
...
public abstract class MenuTools extends Menu {
	...
	private List<ToggleableTool> compile0(final Object... tools) {
	...
	private ToggleableTool findTool(final ItemStack item) {
