package com.cursedplanet.cursedlibrary.lib.settings;

import com.cursedplanet.cursedlibrary.lib.FileUtil;
import com.cursedplanet.cursedlibrary.lib.SerializeUtil;
import com.cursedplanet.cursedlibrary.lib.Valid;
import com.cursedplanet.cursedlibrary.lib.command.DebugCommand;
...
public abstract class SimpleLocalization extends YamlStaticConfig {
	...
	public static final class Commands {
		...
		/**
		 * Key for when plugin is reloading {@link com.cursedplanet.cursedplugins.plugin.SimplePlugin}
		 */
		public static String RELOADING = "reloading";

		/**
		 * Key for when plugin is disabled {@link com.cursedplanet.cursedplugins.plugin.SimplePlugin}
		 */
