...
import com.cursedplanet.cursedlibrary.lib.GeoAPI.GeoResponse;
...
import com.cursedplanet.cursedlibrary.lib.settings.SimpleSettings;
...
public final class Variables {
	...
	private static String lookupVariable0(Player player, CommandSender console, String variable) {
		...
		switch (variable) {
			...
			case "info_prefix":
			case "prefix_info":
				return com.cursedplanet.cursedlibrary.lib.Messenger.getInfoPrefix();
			case "success_prefix":
			case "prefix_success":
				return com.cursedplanet.cursedlibrary.lib.Messenger.getSuccessPrefix();
			case "warn_prefix":
			case "prefix_warn":
				return com.cursedplanet.cursedlibrary.lib.Messenger.getWarnPrefix();
			case "error_prefix":
			case "prefix_error":
				return com.cursedplanet.cursedlibrary.lib.Messenger.getErrorPrefix();
			case "question_prefix":
			case "prefix_question":
				return com.cursedplanet.cursedlibrary.lib.Messenger.getQuestionPrefix();
			case "announce_prefix":
			case "prefix_announce":
				return com.cursedplanet.cursedlibrary.lib.Messenger.getAnnouncePrefix();
		}
